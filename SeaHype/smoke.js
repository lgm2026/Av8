...
setTimeout(function () {
  try {
    ...
    ids.forEach(function (id) {
      ...
      if (!l.sources || !l.sources.length) srcIssues++;
        ...
        l.sources.forEach(function (s) {
          if (!s.url || s.url.indexOf("http") !== 0) srcIssues++;
        });
      }
      var qz = l.quiz || [];
      if (!qz.length) {
    ...
    ok(
      typeof win.__seaBoot === "function",
      "window.__seaBoot was not defined by the app",
    );
    ...
    setTimeout(function () {
      ...
      ok(
        txt.indexOf("dive") > -1 ||
          txt.indexOf("Welcome") > -1 ||
          txt.indexOf("SeaHype") > -1 ||
          txt.length > 80,
        "mounted content looks empty",
      );
